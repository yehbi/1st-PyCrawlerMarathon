...
class PttcrawlerSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        items = response.css('div[class="article-metaline"]')
        print(items)
        print(items[0].css('span[class="article-meta-value"]::text')[0].get())
        print(items[1].css('span[class="article-meta-value"]::text')[0].get())
        print(items[2].css('span[class="article-meta-value"]::text')[0].get())
