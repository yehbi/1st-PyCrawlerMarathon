...
class JSONPipeline(object):
    def open_spider(self, spider):
        ...
        self.runtime_file_path = str(self.dir_path / '{board}.tmp.json.swp'.format(board=spider.board))
        print('open_spider {}'.format(spider.board))
    ...
    def close_spider(self, spider):
        ...
        print('Name {}'.format(spider.board))
        ...
        print('Save result at {}'.format(self.store_file_path))
